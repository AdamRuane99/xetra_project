...
class S3BucketConnector():
    ...
    def list_files_in_prefix(self, prefix: str):
         """
         listing all files for prefix on the s3 bucket.

         :param prefix: refix on the S3 bucket that should be filtred

         returns: List of all file names containing the prefix in the key.
